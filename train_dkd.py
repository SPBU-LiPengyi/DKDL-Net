...
def train_student(config, dataloader, tnet_best):
    ...
    if not os.path.exists('Pth'):
        os.mkdir('Pth')
    file = "Pth/" + "DKD11_" + 'Smodel' + str(config.snr) + '_' + config.chosen_data + '_'  + str(round(acc_max.item(),2)) + ".pth"
    torch.save(student_model.state_dict(), file)
    wandb.save('*.pth')
...
if __name__ == '__main__':
    ...
    wandb.init(project="BearingPGA-Net", entity="lipengyi0829")
